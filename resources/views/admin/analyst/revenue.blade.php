        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title" style="display: flex;justify-content: space-between;">
                    <div style="width: 30rem;"><h5>Doanh thu</h5></div>
                ...
                <div class="ibox-content">
                    <div class="ibox-title" style="margin-left:4rem;">
                        ...
                        <p style="font-size: 20px;font-weight: bold;" id="total-revenue">Tổng: {{$total}} VND</p>
                    </div>
                    <div>
                ...
                <div class="ibox-content">
                    <div class="ibox-title">
                        <h5>Tỉ trọng doanh thu theo category</h5>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
...
<script src="{{asset('public/js/revenue.js')}}"></script>
@endsection